...
local function GetGeneralAppearances()
	...
	set = AddSet(70000,nil,col,41,"LG_CASTER_INT_90",ANY,ANY,CASTER,ANY)
				AddVariant(70000,nil,col,set,"LG_CASTER_INT_90",TRANSMOG,A(20801,54617))
	set = AddSet(70000,nil,col,42,"LG_HEALER_INT_90",ANY,ANY,HEALER,ANY)
				AddVariant(70000,nil,col,set,"LG_HEALER_INT_90",TRANSMOG,A(20825))	
	set = AddSet(70000,nil,col,43,"LG_MELEE_AGI_90",ANY,ANY,MELEE,ANY)
				AddVariant(70000,nil,col,set,"LG_MELEE_AGI_90",TRANSMOG,A(20805))
	...
	set = AddSet(70000,nil,col,3,"LG_HEALER_80",ANY,ANY,HEALER,ANY)
				AddVariant(70000,nil,col,set,"LG_HEALER_80",TRANSMOG,A(11613))
	...
	set = AddSet(70000,nil,col,1,"LG_60",ANY,ANY,TANK,ANY)
				AddVariant(70000,nil,col,set,"LG_60",TRANSMOG,A(5131))
	...
	col = HOLIDAY
	--[[set = AddSet(50400,nil,col,1103271,"HO_FESTIVE_DRESS",ANY,ANY,ANY)
				AddVariant(50400,nil,col,set,"GREEN",NOTRANSMOG,21157)
				AddVariant(50400,nil,col,set,"PINK",NOTRANSMOG,21538)
				AddVariant(50400,nil,col,set,"PURPLE",NOTRANSMOG,21539)
				AddVariant(50400,nil,col,set,"RED",NOTRANSMOG,21154)
				
	set = AddSet(50400,nil,col,1103272,"HO_FESTIVE_SUIT",ANY,ANY,ANY)
				AddVariant(50400,nil,col,set,"BLACK",NOTRANSMOG,21541)
				AddVariant(50400,nil,col,set,"BLUE",NOTRANSMOG,21544)
				AddVariant(50400,nil,col,set,"TEAL",NOTRANSMOG,21543)
				AddVariant(50400,nil,col,set,"RED",NOTRANSMOG,21542)
				
	set = AddSet(50400,nil,col,1203351,"HO_LOVELY_DRESS",ANY,ANY,ANY)
				AddVariant(50400,nil,col,set,"BLACK",NOTRANSMOG,22279)
				AddVariant(50400,nil,col,set,"BLUE",NOTRANSMOG,22278)
				AddVariant(50400,nil,col,set,"PURPLE",NOTRANSMOG,22280)
				AddVariant(50400,nil,col,set,"RED",NOTRANSMOG,22276)
				
	set = AddSet(50400,nil,col,1203352,"HO_DINNER_SUIT",ANY,ANY,ANY)
				AddVariant(50400,nil,col,set,"BLUE",NOTRANSMOG,22281)
				AddVariant(50400,nil,col,set,"PURPLE",NOTRANSMOG,22282)
				AddVariant(50400,nil,col,set,"RED",NOTRANSMOG,22277)
				
	set = AddSet(50400,nil,col,1401811,"HO_ELEGANT_DRESS",ANY,ANY,ANY)
				AddVariant(50400,nil,col,set,"HO_ELEGANT_DRESS",NOTRANSMOG,19028)
				
	set = AddSet(50400,nil,col,1401812,"HO_TUXEDO",ANY,ANY,ANY)
				AddVariant(50400,nil,col,set,"BLACK",NOTRANSMOG,6833,6835)
				
	set = AddSet(50400,nil,col,1603411,"HO_MIDSUMMER_REVELER",ANY,ANY,ANY)
				AddVariant(50400,nil,col,set,"RED",NOTRANSMOG,23324,34685,34683)
				
	set = AddSet(50400,nil,col,1903721,"HO_BREWFEST_DRESS",ANY,ANY,ANY)
				AddVariant(50400,nil,col,set,"BLUE",NOTRANSMOG,33968,33863,33966)
				AddVariant(50400,nil,col,set,"BROWN",NOTRANSMOG,33864,33863,33966)
				AddVariant(50400,nil,col,set,"GREEN",NOTRANSMOG,33967,33863,33966)
				AddVariant(50400,nil,col,set,"PURPLE",NOTRANSMOG,33969,33863,33966)
				
	set = AddSet(50400,nil,col,1903722,"HO_BREWFEST_REGALIA",ANY,ANY,ANY)
				AddVariant(50400,nil,col,set,"BLUE",NOTRANSMOG,33968,33862,33868)
				AddVariant(50400,nil,col,set,"BROWN",NOTRANSMOG,33864,33862,33868)
				AddVariant(50400,nil,col,set,"GREEN",NOTRANSMOG,33967,33862,33868)
				AddVariant(50400,nil,col,set,"PURPLE",NOTRANSMOG,33969,33862,33868)
	
	set = AddSet(50400,nil,col,2003241,"HO_HALLOWED_HELM",ANY,ANY,ANY)
				AddVariant(50400,nil,col,set,"BLACK",NOTRANSMOG,33292)
	
	set = AddSet(50400,nil,col,2003242,"HO_HORSEMANS_HOOD",DEATHKNIGHT,ANY,ANY)
				AddVariant(50400,nil,col,set,"L90",NOTRANSMOG,87569)
				AddVariant(50400,nil,col,set,"L100",NOTRANSMOG,117355)
	
	set = AddSet(50400,nil,col,2003242,"HO_HORSEMANS_HOOD",PALADIN,ANY,ANY)
				AddVariant(50400,nil,col,set,"L90",NOTRANSMOG,87569)
				AddVariant(50400,nil,col,set,"L100",NOTRANSMOG,117355)
	
	set = AddSet(50400,nil,col,2003242,"HO_HORSEMANS_HOOD",WARRIOR,ANY,ANY)
				AddVariant(50400,nil,col,set,"L90",NOTRANSMOG,87569)
				AddVariant(50400,nil,col,set,"L100",NOTRANSMOG,117355)
	
	set = AddSet(50400,nil,col,2003243,"HO_HORSEMANS_SLICER",ROGUE,ANY,ANY)
				AddVariant(50400,nil,col,set,"L90",NOTRANSMOG,87570)
				AddVariant(50400,nil,col,set,"L100",NOTRANSMOG,117356)
	
	set = AddSet(50400,nil,col,2104041,"HO_PILGRIMS_ATTIRE",ANY,ANY,ANY)
				AddVariant(50400,nil,col,set,"BLACK",NOTRANSMOG,46723,46800,44788)
				AddVariant(50400,nil,col,set,"FINE",NOTRANSMOG,116401,46800,44788)
	
	set = AddSet(50400,nil,col,2104042,"HO_PILGRIMS_DRESS",ANY,ANY,ANY)
				AddVariant(50400,nil,col,set,"BLACK",NOTRANSMOG,46723,44785,44788)
				AddVariant(50400,nil,col,set,"FINE",NOTRANSMOG,116401,44785,44788)]]--
	
	set = AddSet(70000,nil,col,2201411,"HO_WINTER_GARB",ANY,ANY,ANY,ANY)
				AddVariant(70000,nil,col,set,"GREEN",NOTRANSMOG,A(5771,nil,21525),A(8831,nil,34087),A(8830,nil,34086))
				AddVariant(70000,nil,col,set,"RED",NOTRANSMOG,A(5770,nil,21524),A(8829,nil,34085),A(8830,nil,34086))
...
local function GetMonkAppearances()
	...
	set = AddSet(70000,nil,col,191,"MO_TR_19",LEATHER,MONK,ANY,ANY)
				...
				AddVariant(70000,nil,col,set,"NORMAL",TRANSMOG,A(32043),A(32046),A(31917),A(32042),A(32044),A(32045))
...
local function GetPriestAppearances()
	...
	set = AddSet(70000,nil,col,91,"PR_TR_CASTER_H_09",CLOTH,PRIEST,ANY,HORDE)
				...
				AddVariant(70000,nil,col,set,"NORMAL",TRANSMOG,A(11919,23221),A(11935,23218),A(11807,23219),A(11982,23222),A(11815,23220))
				AddVariant(70000,nil,col,set,"HEROIC",TRANSMOG,A(11919,23214),A(11935,223217),A(11807,23216),A(11982,23213),A(11815,23215))
	...
	set = AddSet(70000,nil,col,90,"PR_CD_90",CLOTH,PRIEST,ANY,ANY)
				AddVariant(70000,nil,col,set,"PR_CD_90",TRANSMOG,A(19482),A(19481),A(18917),A(18916),A(18918),A(19480),A(18920),A(18914))
...
local function GetRogueAppearances()
	...
	set = AddSet(70000,nil,col,90,"RO_CD_90",LEATHER,ROGUE,ANY,ANY)
				AddVariant(70000,nil,col,set,"RO_CD_90",TRANSMOG,A(17620),A(17625),A(17622),A(17626),A(17623),A(17619),A(17624),A(17621))
...
local function GetShamanAppearances()
	...
	set = AddSet(70000,nil,col,30,"SH_TR_03",MAIL,SHAMAN,ANY,ANY)
				AddVariant(70000,nil,col,set,"SH_TR_03",TRANSMOG,A(6001),A(6002),A(5999),A(6006),A(6004),A(6005),A(6000),A(6003))
	...
	set = AddSet(70000,nil,col,90,"SH_CD_90",MAIL,SHAMAN,ANY,ANY)
				AddVariant(70000,nil,col,set,"SH_CD_90",TRANSMOG,A(17856),A(17858),A(17854),A(17851),A(17855),A(17852),A(17857),A(17853))
