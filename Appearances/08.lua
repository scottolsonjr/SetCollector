...
local function GetPvpAppearances()
	...
	set = SetCollector:AddSet(80000,nil,col,10801,"PVP_LEATHER_H_22",LEATHER,ANY,ANY,ALLIANCE,loc)
	...
	set = SetCollector:AddSet(80000,nil,col,10801,"PVP_MAIL_H_22",MAIL,ANY,ANY,ALLIANCE,loc)
	...
	set = SetCollector:AddSet(80000,nil,col,10801,"PVP_PLATE_H_22",PLATE,ANY,ANY,ALLIANCE,loc)
