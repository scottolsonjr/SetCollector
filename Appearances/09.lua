...
local function GetExpansionAppearances()
    ...
    set = SetCollector:AddSetLegacy(90000,nil,col,10904,"EX_CLOTH_0904",CLOTH,ANY,ANY,ANY)
        ...
        SetCollector:AddVariantLegacy(90000,nil,col,set,"RENOWN",TRANSMOG,A(42479,111120),A(42480,111125),A(42476,111121),A(42482,111127),A(42478,111123),A(42481,111126),A(42475,111124),A(42477,111122))
    ...
    set = SetCollector:AddSetLegacy(90000,nil,col,10904,"EX_LEATHER_0904",LEATHER,ANY,ANY,ANY)
        ...
        SetCollector:AddVariantLegacy(90000,nil,col,set,"RENOWN",TRANSMOG,A(42277,110582),A(),A(),A(),A(),A(),A(),A(),A())
        SetCollector:AddVariantLegacy(90000,nil,col,set,"3",TRANSMOG,A(),A(),A(),A(),A(),A(),A(),A(),A())
        SetCollector:AddVariantLegacy(90000,nil,col,set,"4",TRANSMOG,A(),A(),A(),A(),A(),A(),A(),A(),A())
    set = SetCollector:AddSetLegacy(90000,nil,col,10904,"EX_MAIL_0904",MAIL,ANY,ANY,ANY)
        ...
        SetCollector:AddVariantLegacy(90000,nil,col,set,"RENOWN",TRANSMOG,A(42915,112719),A(42921,112721),A(42903,112716),A(42927,112723),A(42912,112718),A(42924,112722),A(42918,112720),A(42909,112717))
        SetCollector:AddVariantLegacy(90000,nil,col,set,"3",TRANSMOG,A(),A(),A(),A(),A(),A(),A(),A(),A())
    ...
    set = SetCollector:AddSetLegacy(90000,nil,col,10904,"EX_PLATE_0904",PLATE,ANY,ANY,ANY)
        ...
        SetCollector:AddVariantLegacy(90000,nil,col,set,"RENOWN",TRANSMOG,A(41384,110871),A(41390,110876),A(41372,110872),A(41396,110878),A(41381,110874),A(41393,110877),A(41387,110875),A(41378,110873))
        SetCollector:AddVariantLegacy(90000,nil,col,set,"3",TRANSMOG,A(),A(),A(),A(),A(),A(),A(),A(),A())
        SetCollector:AddVariantLegacy(90000,nil,col,set,"4",TRANSMOG,A(),A(),A(),A(),A(),A(),A(),A(),A())
    -- Venthyr
