...
local function GetDruidAppearances()
    ...
    loc = "LOC_RAID_0104"
    set = SetCollector:AddSetLegacy(70000,nil,col,10104,"DR_DG_AQ_2",LEATHER,DRUID,ANY,ANY,loc)
    ...
    loc = "LOC_RAID_0103"
    set = SetCollector:AddSetLegacy(70000,nil,col,10103,"DR_TR_03",LEATHER,DRUID,ANY,ANY,loc)
    ...
    loc = "LOC_RAID_0102"
    set = SetCollector:AddSetLegacy(70000,nil,col,10102,"DR_TR_02",LEATHER,DRUID,ANY,ANY,loc)
    ...
    loc = "LOC_RAID_0101"
    set = SetCollector:AddSetLegacy(70000,nil,col,10101,"DR_TR_01",LEATHER,DRUID,ANY,ANY,loc)
...
local function GetHunterAppearances()
    ...
    col = SetCollector.RAID
    loc = "LOC_RAID_0104"
    set = SetCollector:AddSetLegacy(70000,nil,col,10104,"HU_DG_AQ_2",MAIL,HUNTER,ANY,ANY,loc)
                SetCollector:AddVariantLegacy(70000,nil,col,set,"HU_DG_AQ_2",TRANSMOG,A(5698,8395),A(5699,8396),A(5701,8398),A(5736,8541),A(5700,8397),A(5697,8394))
    loc = "LOC_RAID_0103"
    set = SetCollector:AddSetLegacy(70000,nil,col,10103,"HU_TR_03",MAIL,HUNTER,ANY,ANY,loc)
                SetCollector:AddVariantLegacy(70000,nil,col,set,"HU_TR_03",TRANSMOG,A(5993,8840),A(5994,8841),A(5991,8838),A(5998,8845),A(5996,8843),A(5997,8844),A(5992,8839),A(5995,8842)) --,A(nil,nil,23067))
    loc = "LOC_RAID_0102"
    set = SetCollector:AddSetLegacy(70000,nil,col,10102,"HU_TR_02",MAIL,HUNTER,ANY,ANY,loc)
                SetCollector:AddVariantLegacy(70000,nil,col,set,"HU_TR_02",TRANSMOG,A(5062,7003),A(5060,7001),A(5065,7006),A(5058,6999),A(5063,7004),A(5059,7000),A(5061,7002),A(5064,7005))
    loc = "LOC_RAID_0101"
    set = SetCollector:AddSetLegacy(70000,nil,col,10101,"HU_TR_01",MAIL,HUNTER,ANY,ANY,loc)
                SetCollector:AddVariantLegacy(70000,nil,col,set,"HU_TR_01",TRANSMOG,A(4991,6931),A(4993,6933),A(4990,6930),A(4995,6935),A(4997,6937),A(4996,6936),A(4992,6932),A(4994,6934))
...
local function GetMageAppearances()
    ...
    set = SetCollector:AddSetLegacy(70000,nil,col,10103,"MA_TR_03",CLOTH,MAGE,ANY,ANY,loc)
                SetCollector:AddVariantLegacy(70000,nil,col,set,"MA_TR_03",TRANSMOG,A(6025,8874),A(6026,8875),A(6023,8872),A(1474,8879),A(6028,8877),A(6029,8878),A(6024,8873),A(6027,8876))
    loc = "LOC_RAID_0102"
    set = SetCollector:AddSetLegacy(70000,nil,col,10102,"MA_TR_02",CLOTH,MAGE,ANY,ANY,loc)
                SetCollector:AddVariantLegacy(70000,nil,col,set,"MA_TR_02",TRANSMOG,A(5038,6978),A(5041,6981),A(5040,6980),A(5042,6982),A(5037,6977),A(4963,6903),A(5039,6979),A(5036,6976))
    loc = "LOC_RAID_0101"
    set = SetCollector:AddSetLegacy(70000,nil,col,10101,"MA_TR_01",CLOTH,MAGE,ANY,ANY,loc)
...
local function GetPaladinAppearances()
    ...
    col = SetCollector.RAID
    loc = "LOC_RAID_0104"
    set = SetCollector:AddSetLegacy(70000,nil,col,10104,"PA_DG_AQ_2",PLATE,PALADIN,ANY,ANY,loc)
    ...
    loc = "LOC_RAID_0103"
    set = SetCollector:AddSetLegacy(70000,nil,col,10103,"PA_TR_03",PLATE,PALADIN,ANY,ANY,loc)
    ...
    loc = "LOC_RAID_0102"
    set = SetCollector:AddSetLegacy(70000,nil,col,10102,"PA_TR_02",PLATE,PALADIN,ANY,ANY,loc)
    ...
    loc = "LOC_RAID_0101"
    set = SetCollector:AddSetLegacy(70000,nil,col,10101,"PA_TR_01",PLATE,PALADIN,ANY,ANY,loc)
...
local function GetPriestAppearances()
    ...
    col = SetCollector.RAID
    loc = "LOC_RAID_0104"
    set = SetCollector:AddSetLegacy(70000,nil,col,10104,"PR_DG_AQ_2",CLOTH,PRIEST,ANY,ANY,loc)
    ...
    loc = "LOC_RAID_0103"
    set = SetCollector:AddSetLegacy(70000,nil,col,10103,"PR_TR_03",CLOTH,PRIEST,ANY,ANY,loc)
    ...
    loc = "LOC_RAID_0102"
    set = SetCollector:AddSetLegacy(70000,nil,col,10102,"PR_TR_02",CLOTH,PRIEST,ANY,ANY,loc)
    ...
    loc = "LOC_RAID_0101"
    set = SetCollector:AddSetLegacy(70000,nil,col,10101,"PR_TR_01",CLOTH,PRIEST,ANY,ANY,loc)
...
local function GetRogueAppearances()
    ...
    col = SetCollector.RAID
    loc = "LOC_RAID_0104"
    set = SetCollector:AddSetLegacy(70000,nil,col,10104,"RO_DG_AQ_2",LEATHER,ROGUE,ANY,ANY,loc)
    ...
    loc = "LOC_RAID_0103"
    set = SetCollector:AddSetLegacy(70000,nil,col,10103,"RO_TR_03",LEATHER,ROGUE,ANY,ANY,loc)
    ...
    loc = "LOC_RAID_0102"
    set = SetCollector:AddSetLegacy(70000,nil,col,10102,"RO_TR_02",LEATHER,ROGUE,ANY,ANY,loc)
    ...
    loc = "LOC_RAID_0101"
    set = SetCollector:AddSetLegacy(70000,nil,col,10101,"RO_TR_01",LEATHER,ROGUE,ANY,ANY,loc)
    ...
    col = SetCollector.DUNGEON
    set = SetCollector:AddSetLegacy(70000,nil,col,30,"RO_DG_03",LEATHER,ROGUE,ANY,ANY)    -- Move to BC
...
local function GetShamanAppearances()
    ...
    col = SetCollector.RAID
    loc = "LOC_RAID_0104"
    set = SetCollector:AddSetLegacy(70000,nil,col,10104,"SH_DG_AQ_2",MAIL,SHAMAN,ANY,ANY,loc)
    ...
    loc = "LOC_RAID_0103"
    set = SetCollector:AddSetLegacy(70000,nil,col,10103,"SH_TR_03",MAIL,SHAMAN,ANY,ANY,loc)
    ...
    loc = "LOC_RAID_0102"
    set = SetCollector:AddSetLegacy(70000,nil,col,10102,"SH_TR_02",MAIL,SHAMAN,ANY,ANY,loc)
    ...
    loc = "LOC_RAID_0101"
    set = SetCollector:AddSetLegacy(70000,nil,col,10101,"SH_TR_01",MAIL,SHAMAN,ANY,ANY,loc)
    ...
    col = SetCollector.DUNGEON
    set = SetCollector:AddSetLegacy(70000,nil,col,30,"SH_DG_03",MAIL,SHAMAN,ANY,ANY)  -- Move to BC
...
local function GetWarlockAppearances()
    ...
    col = SetCollector.DUNGEON
    set = SetCollector:AddSetLegacy(70000,nil,col,30,"WK_DG_03",CLOTH,WARLOCK,ANY,ANY)    -- Move to BC
...
local function GetWarriorAppearances()
    ...
    loc = "LOC_RAID_0102"
    set = SetCollector:AddSetLegacy(70000,nil,col,10102,"WR_TR_02",PLATE,WARRIOR,ANY,ANY,loc)
    ...
    loc = "LOC_RAID_0101"
    set = SetCollector:AddSetLegacy(70000,nil,col,10101,"WR_TR_01",PLATE,WARRIOR,ANY,ANY,loc)
    ...
    col = SetCollector.DUNGEON
    set = SetCollector:AddSetLegacy(70000,nil,col,30,"WR_DG_03",PLATE,WARRIOR,ANY,ANY)    -- Move to BC
