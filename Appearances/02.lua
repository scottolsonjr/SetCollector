...
local function GetDruidAppearances()
	...
	set = SetCollector:AddSet(70000,nil,col,10203,"DR_TR_CASTER_06",LEATHER,DRUID,ANY,ANY)
	...
	set = SetCollector:AddSet(70000,nil,col,10202,"DR_TR_CASTER_05",LEATHER,DRUID,ANY,ANY)
	...
	set = SetCollector:AddSet(70000,nil,col,10201,"DR_TR_CASTER_04",LEATHER,DRUID,ANY,ANY)
...
local function GetHunterAppearances()
	...
	col = SetCollector.RAID
	set = SetCollector:AddSet(70000,nil,col,10203,"HU_TR_RANGED_06",MAIL,HUNTER,ANY,ANY)
	...
	set = SetCollector:AddSet(70000,nil,col,10202,"HU_TR_RANGED_05",MAIL,HUNTER,ANY,ANY)
	...
	set = SetCollector:AddSet(70000,nil,col,10201,"HU_TR_RANGED_04",MAIL,HUNTER,ANY,ANY)
...
local function GetMageAppearances()
	...
	col = SetCollector.RAID
	set = SetCollector:AddSet(70000,nil,col,10203,"MA_TR_CASTER_06",CLOTH,MAGE,ANY,ANY)
	...
	set = SetCollector:AddSet(70000,nil,col,10202,"MA_TR_CASTER_05",CLOTH,MAGE,ANY,ANY)
	...
	set = SetCollector:AddSet(70000,nil,col,10201,"MA_TR_CASTER_04",CLOTH,MAGE,ANY,ANY)
...
local function GetPaladinAppearances()
	...
	col = SetCollector.RAID
	set = SetCollector:AddSet(70000,nil,col,10203,"PA_TR_MELEE_06",PLATE,PALADIN,ANY,ANY)
	...
	set = SetCollector:AddSet(70000,nil,col,10202,"PA_TR_MELEE_05",PLATE,PALADIN,ANY,ANY)
	...
	set = SetCollector:AddSet(70000,nil,col,10201,"PA_TR_MELEE_04",PLATE,PALADIN,ANY,ANY)
...
local function GetPriestAppearances()
	...
	col = SetCollector.RAID
	set = SetCollector:AddSet(70000,nil,col,10203,"PR_TR_CASTER_06",CLOTH,PRIEST,ANY,ANY)
	...
	set = SetCollector:AddSet(70000,nil,col,10202,"PR_TR_CASTER_05",CLOTH,PRIEST,ANY,ANY)
	...
	set = SetCollector:AddSet(70000,nil,col,10201,"PR_TR_CASTER_04",CLOTH,PRIEST,ANY,ANY)
...
local function GetRogueAppearances()
	...
	col = SetCollector.RAID
	set = SetCollector:AddSet(70000,nil,col,10203,"RO_TR_MELEE_06",LEATHER,ROGUE,ANY,ANY)
	...
	set = SetCollector:AddSet(70000,nil,col,10202,"RO_TR_MELEE_05",LEATHER,ROGUE,ANY,ANY)
	...
	set = SetCollector:AddSet(70000,nil,col,10201,"RO_TR_MELEE_04",LEATHER,ROGUE,ANY,ANY)
...
local function GetShamanAppearances()
	...
	col = SetCollector.RAID
	set = SetCollector:AddSet(70000,nil,col,10204,"SH_TR_CASTER_06B",MAIL,SHAMAN,ANY,ANY)
	...
	set = SetCollector:AddSet(70000,nil,col,10203,"SH_TR_CASTER_06",MAIL,SHAMAN,ANY,ANY)
	...
	set = SetCollector:AddSet(70000,nil,col,10202,"SH_TR_CASTER_05",MAIL,SHAMAN,ANY,ANY)
	...
	set = SetCollector:AddSet(70000,nil,col,10201,"SH_TR_CASTER_04",MAIL,SHAMAN,ANY,ANY)
...
local function GetWarlockAppearances()
	...
	col = SetCollector.RAID
	set = SetCollector:AddSet(70000,nil,col,10203,"WK_TR_CASTER_06",CLOTH,WARLOCK,ANY,ANY)
	...
	set = SetCollector:AddSet(70000,nil,col,10202,"WK_TR_CASTER_05",CLOTH,WARLOCK,ANY,ANY)
	...
	set = SetCollector:AddSet(70000,nil,col,10201,"WK_TR_CASTER_04",CLOTH,WARLOCK,ANY,ANY)
...
local function GetWarriorAppearances()
	...
	col = SetCollector.RAID
	set = SetCollector:AddSet(70000,nil,col,10203,"WR_TR_TANK_06",PLATE,WARRIOR,ANY,ANY)
				SetCollector:AddVariant(70000,nil,col,set,"WR_TR_TANK_06",TRANSMOG,A(8059),A(8062),A(8060),A(8960),A(8058),A(8996),A(8061),A(9007))

	set = SetCollector:AddSet(70000,nil,col,10202,"WR_TR_TANK_05",PLATE,WARRIOR,ANY,ANY)
				SetCollector:AddVariant(70000,nil,col,set,"WR_TR_TANK_05",TRANSMOG,A(7811),A(7813),A(7809),A(7810),A(7812))
	
	set = SetCollector:AddSet(70000,nil,col,10201,"WR_TR_TANK_04",PLATE,WARRIOR,ANY,ANY)
