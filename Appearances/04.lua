...
local function GetDeathKnightAppearances()
    ...
    loc = "LOC_RAID_0403"
    set = SetCollector:AddSetLegacy(70000,nil,col,10403,"DK_TR_TANK_13",PLATE,DEATHKNIGHT,ANY,ANY,loc)
    ...
    loc = "LOC_RAID_0402"
    set = SetCollector:AddSetLegacy(70000,nil,col,10402,"DK_TR_TANK_12",PLATE,DEATHKNIGHT,ANY,ANY,loc)
    ...
    loc = "LOC_RAID_0401"
    set = SetCollector:AddSetLegacy(70000,nil,col,10401,"DK_TR_TANK_11",PLATE,DEATHKNIGHT,ANY,ANY,loc)
...
local function GetPaladinAppearances()
    ...
    col = SetCollector.RAID
    loc = "LOC_RAID_0403"
    set = SetCollector:AddSetLegacy(70000,nil,col,10403,"PA_TR_TANK_13",PLATE,PALADIN,ANY,ANY,loc)
    ...
    loc = "LOC_RAID_0402"
    set = SetCollector:AddSetLegacy(70000,nil,col,10402,"PA_TR_TANK_12",PLATE,PALADIN,ANY,ANY,loc)
        SetCollector:AddVariantLegacy(70000,nil,col,set,"NORMAL",TRANSMOG,A(15681,36433),A(15683,36435),A(15685,36431),A(15684,36401),A(15530,36432),A(),A(15682,36434),A(15539,36607))
    ...
    loc = "LOC_RAID_0401"
    set = SetCollector:AddSetLegacy(70000,nil,col,10401,"PA_TR_TANK_11",PLATE,PALADIN,ANY,ANY,loc)
...
local function GetRogueAppearances()
    ...
    set = SetCollector:AddSetLegacy(70000,nil,col,10402,"RO_TR_MELEE_12",LEATHER,ROGUE,ANY,ANY,loc)
        SetCollector:AddVariantLegacy(70000,nil,col,set,"NORMAL",TRANSMOG,A(15642,36417),A(15644,36419),A(15641,36415),A(13986,29578),A(15533,36416),A(13591,29712),A(15643,36418),A(13908,29692))
        SetCollector:AddVariantLegacy(70000,nil,col,set,"HEROIC",TRANSMOG,A(15649,36765),A(15651,36767),A(15647,36763),A(14727,32642),A(15648,36764),A(14091,32697),A(15650,36766),A(14769,32715))
    loc = "LOC_RAID_0401"
...
local function GetWarlockAppearances()
    ...
    col = SetCollector.RAID
    loc = "LOC_RAID_0403"
    set = SetCollector:AddSetLegacy(70000,nil,col,10403,"WK_TR_CASTER_13",CLOTH,WARLOCK,ANY,ANY,loc)
        SetCollector:AddVariantLegacy(70000,nil,col,set,"RAIDFINDER",TRANSMOG,A(16549,40134),A(16545,40181),A(16547,40162),A(18081,44694),A(16548,40113),A(19009,44730),A(16550,40153),A(18079,44711))
        SetCollector:AddVariantLegacy(70000,nil,col,set,"NORMAL",TRANSMOG,A(16558,38563),A(16554,38560),A(16556,38561),A(18090,44298),A(16557,38564),A(18087,44345),A(16559,38562),A(18088,44315))
        SetCollector:AddVariantLegacy(70000,nil,col,set,"HEROIC",TRANSMOG,A(16540,40039),A(16536,40086),A(16538,40067),A(18072,44809),A(16539,40018),A(18069,44835),A(16541,40058),A(18070,44825))
    loc = "LOC_RAID_0402"
    set = SetCollector:AddSetLegacy(70000,nil,col,10402,"WK_TR_CASTER_12",CLOTH,WARLOCK,ANY,ANY,loc)
    ...
    loc = "LOC_RAID_0401"
    set = SetCollector:AddSetLegacy(70000,nil,col,10401,"WK_TR_CASTER_11",CLOTH,WARLOCK,ANY,ANY,loc)
