...
local function GetDeathKnightAppearances()
    ...
    loc = "LOC_RAID_0304"
    set = SetCollector:AddSetLegacy(70000,nil,col,10304,"DK_RAID_0304",PLATE,DEATHKNIGHT,ANY,ANY,loc)
    ...
    loc = "LOC_RAID_0302"
    set = SetCollector:AddSetLegacy(70000,nil,col,10302,"DK_RAID_0302",PLATE,DEATHKNIGHT,ANY,ANY,loc)
    ...
    loc = "LOC_RAID_0301"
    set = SetCollector:AddSetLegacy(70000,nil,col,10301,"DK_RAID_0301",PLATE,DEATHKNIGHT,ANY,ANY,loc)
...
local function GetDruidAppearances()
    ...
    col = SetCollector.RAID
    loc = "LOC_RAID_0304"
    set = SetCollector:AddSetLegacy(70000,nil,col,10304,"DR_RAID_0304",LEATHER,DRUID,ANY,ANY,loc)
    ...
    loc = "LOC_RAID_0303"
    set = SetCollector:AddSetLegacy(70000,nil,col,10303,"DR_RAID_A_0303",LEATHER,DRUID,ANY,ALLIANCE,loc)
    ...
    set = SetCollector:AddSetLegacy(70000,nil,col,10303,"DR_RAID_H_0303",LEATHER,DRUID,ANY,HORDE,loc)
    ...
    loc = "LOC_RAID_0302"
    set = SetCollector:AddSetLegacy(70000,nil,col,10302,"DR_RAID_0302",LEATHER,DRUID,ANY,ANY,loc)
    ...
    loc = "LOC_RAID_0301"
    set = SetCollector:AddSetLegacy(70000,nil,col,10301,"DR_RAID_0301",LEATHER,DRUID,ANY,ANY,loc)
...
local function GetHunterAppearances()
    ...
    col = SetCollector.RAID
    loc = "LOC_RAID_0304"
    set = SetCollector:AddSetLegacy(70000,nil,col,10304,"HU_RAID_0304",MAIL,HUNTER,ANY,ANY,loc)
    ...
    loc = "LOC_RAID_0303"
    set = SetCollector:AddSetLegacy(70000,nil,col,10303,"HU_RAID_A_0303",MAIL,HUNTER,ANY,ALLIANCE,loc)
    ...
    set = SetCollector:AddSetLegacy(70000,nil,col,10303,"HU_RAID_H_0303",MAIL,HUNTER,ANY,HORDE,loc)
    ...
    loc = "LOC_RAID_0302"
    set = SetCollector:AddSetLegacy(70000,nil,col,10302,"HU_RAID_0302",MAIL,HUNTER,ANY,ANY,loc)
    ...
    loc = "LOC_RAID_0301"
    set = SetCollector:AddSetLegacy(70000,nil,col,10301,"HU_RAID_0301",MAIL,HUNTER,ANY,ANY,loc)
...
local function GetMageAppearances()
    ...
    col = SetCollector.RAID
    loc = "LOC_RAID_0304"
    set = SetCollector:AddSetLegacy(70000,nil,col,10304,"MA_RAID_0304",CLOTH,MAGE,ANY,ANY,loc)
    ...
    loc = "LOC_RAID_0303"
    set = SetCollector:AddSetLegacy(70000,nil,col,10303,"MA_RAID_A_0303",CLOTH,MAGE,ANY,ALLIANCE,loc)
    ...
    set = SetCollector:AddSetLegacy(70000,nil,col,10303,"MA_RAID_H_0303",CLOTH,MAGE,ANY,HORDE,loc)
    ...
    loc = "LOC_RAID_0302"
    set = SetCollector:AddSetLegacy(70000,nil,col,10302,"MA_RAID_0302",CLOTH,MAGE,ANY,ANY,loc)
    ...
    loc = "LOC_RAID_0301"
    set = SetCollector:AddSetLegacy(70000,nil,col,10301,"MA_RAID_0301",CLOTH,MAGE,ANY,ANY,loc)
...
local function GetPaladinAppearances()
    ...
    col = SetCollector.RAID
    loc = "LOC_RAID_0304"
    set = SetCollector:AddSetLegacy(70000,nil,col,10304,"PA_RAID_0304",PLATE,PALADIN,ANY,ANY,loc)
    ...
    loc = "LOC_RAID_0302"
    set = SetCollector:AddSetLegacy(70000,nil,col,10302,"PA_RAID_0302",PLATE,PALADIN,ANY,ANY,loc)
    ...
    loc = "LOC_RAID_0301"
    set = SetCollector:AddSetLegacy(70000,nil,col,10301,"PA_RAID_0301",PLATE,PALADIN,ANY,ANY,loc)
...
local function GetPriestAppearances()
    ...
    col = SetCollector.RAID
    loc = "LOC_RAID_0304"
    set = SetCollector:AddSetLegacy(70000,nil,col,10304,"PR_RAID_0304",CLOTH,PRIEST,ANY,ANY,loc)
    ...
    loc = "LOC_RAID_0302"
    set = SetCollector:AddSetLegacy(70000,nil,col,10302,"PR_RAID_0302",CLOTH,PRIEST,ANY,ANY,loc)
    ...
    loc = "LOC_RAID_0301"
    set = SetCollector:AddSetLegacy(70000,nil,col,10301,"PR_RAID_0301",CLOTH,PRIEST,ANY,ANY,loc)
...
local function GetRogueAppearances()
    ...
    col = SetCollector.RAID
    loc = "LOC_RAID_0304"
    set = SetCollector:AddSetLegacy(70000,nil,col,10304,"RO_RAID_0304",LEATHER,ROGUE,ANY,ANY,loc)
    ...
    loc = "LOC_RAID_0303"
    set = SetCollector:AddSetLegacy(70000,nil,col,10303,"RO_RAID_A_0303",LEATHER,ROGUE,ANY,ALLIANCE,loc)
    ...
    set = SetCollector:AddSetLegacy(70000,nil,col,10303,"RO_RAID_H_0303",LEATHER,ROGUE,ANY,HORDE,loc)
    ...
    loc = "LOC_RAID_0302"
    set = SetCollector:AddSetLegacy(70000,nil,col,10302,"RO_RAID_0302",LEATHER,ROGUE,ANY,ANY,loc)
    ...
    loc = "LOC_RAID_0301"
    set = SetCollector:AddSetLegacy(70000,nil,col,10301,"RO_RAID_0301",LEATHER,ROGUE,ANY,ANY,loc)
...
local function GetShamanAppearances()
    ...
    col = SetCollector.RAID
    loc = "LOC_RAID_0304"
    set = SetCollector:AddSetLegacy(70000,nil,col,10304,"SH_RAID_0304",MAIL,SHAMAN,ANY,ANY,loc)
    ...
    loc = "LOC_RAID_0303"
    set = SetCollector:AddSetLegacy(70000,nil,col,10303,"SH_RAID_A_0303",MAIL,SHAMAN,ANY,ALLIANCE,loc)
    ...
    set = SetCollector:AddSetLegacy(70000,nil,col,10303,"SH_RAID_H_0303",MAIL,SHAMAN,ANY,HORDE,loc)
    ...
    loc = "LOC_RAID_0302"
    set = SetCollector:AddSetLegacy(70000,nil,col,10302,"SH_RAID_0302",MAIL,SHAMAN,ANY,ANY,loc)
    ...
    loc = "LOC_RAID_0301"
    set = SetCollector:AddSetLegacy(70000,nil,col,10301,"SH_RAID_0301",MAIL,SHAMAN,ANY,ANY,loc)
...
local function GetWarlockAppearances()
    ...
    col = SetCollector.RAID
    loc = "LOC_RAID_0304"
    set = SetCollector:AddSetLegacy(70000,nil,col,10304,"WK_RAID_0304",CLOTH,WARLOCK,ANY,ANY,loc)
    ...
    loc = "LOC_RAID_0303"
    set = SetCollector:AddSetLegacy(70000,nil,col,10303,"WK_RAID_A_0303",CLOTH,WARLOCK,ANY,ALLIANCE,loc)
    ...
    set = SetCollector:AddSetLegacy(70000,nil,col,10303,"WK_RAID_H_0303",CLOTH,WARLOCK,ANY,HORDE,loc)
    ...
    loc = "LOC_RAID_0302"
    set = SetCollector:AddSetLegacy(70000,nil,col,10302,"WK_RAID_0302",CLOTH,WARLOCK,ANY,ANY,loc)
    ...
    loc = "LOC_RAID_0301"
    set = SetCollector:AddSetLegacy(70000,nil,col,10301,"WK_RAID_0301",CLOTH,WARLOCK,ANY,ANY,loc)
...
local function GetWarriorAppearances()
    ...
    col = SetCollector.RAID
    loc = "LOC_RAID_0304"
    set = SetCollector:AddSetLegacy(70000,nil,col,10304,"WR_RAID_0304",PLATE,WARRIOR,ANY,ANY,loc)
    ...
    loc = "LOC_RAID_0303"
    set = SetCollector:AddSetLegacy(70000,nil,col,10303,"WR_RAID_A_0303",PLATE,WARRIOR,ANY,ALLIANCE,loc)
    ...
    set = SetCollector:AddSetLegacy(70000,nil,col,10303,"WR_RAID_H_0303",PLATE,WARRIOR,ANY,HORDE,loc)
    ...
    loc = "LOC_RAID_0302"
    set = SetCollector:AddSetLegacy(70000,nil,col,10302,"WR_RAID_0302",PLATE,WARRIOR,ANY,ANY,loc)
    ...
    loc = "LOC_RAID_0301"
    set = SetCollector:AddSetLegacy(70000,nil,col,10301,"WR_RAID_0301",PLATE,WARRIOR,ANY,ANY,loc)
