...
local function GetShamanAppearances()
    ...
    set = SetCollector:AddSetLegacy(70000,nil,col,11,"SH_AR_CASTER_11",MAIL,SHAMAN,CASTER,ANY)
                SetCollector:AddVariantLegacy(70000,nil,col,set,"ONE",TRANSMOG,A(27873,77656,128935),A(30544,78644,128936))
    set = SetCollector:AddSetLegacy(70000,nil,col,10,"SH_AR_MELEE_10",MAIL,SHAMAN,MELEE,ANY)
    ...
    set = SetCollector:AddSetLegacy(70000,nil,col,11,"SH_AR_MELEE_11",MAIL,SHAMAN,MELEE,ANY)
...
local function GetWarlockAppearances()
    ...
    --[[col = SetCollector.ARTIFACT
    set = SetCollector:AddSetLegacy(70000,nil,col,10,"WK_AR_CASTER_10",CLOTH,WARLOCK,CASTER,ANY)                -- Destruction
