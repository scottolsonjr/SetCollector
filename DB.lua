...
local function GetDruidAppearances()
	...
	set = AddSet(70000,nil,col,50,"DR_LG_CASTER_110",LEATHER,DRUID,CASTER,ANY)		-- Balance
				AddVariant(70000,nil,col,set,"DR_LG_CASTER_110",TRANSMOG,A(6935,78747,137062),A(26067,78719,137015),A(12554,78777,137092),A(19854,78714,133976),A(15543,78727,137023))
	set = AddSet(70000,nil,col,50,"DR_LG_MELEE_110",LEATHER,DRUID,MELEE,ANY)		-- Feral
				AddVariant(70000,nil,col,set,"DR_LG_MELEE_110",TRANSMOG,A(26067,78719,137015),A(25591,78741,137056),A(6468,78779,137094),A(19854,78714,133976),A(12217,78728,137024))
	set = AddSet(70000,nil,col,50,"DR_LG_TANK_110",LEATHER,DRUID,TANK,ANY)			-- Guardian
				AddVariant(70000,nil,col,set,"DR_LG_TANK_110",TRANSMOG,A(26067,78719,137015),A(25591,78741,137056),A(19854,78714,133976),A(17323,78752,137067),A(5689,78729,137025))
	set = AddSet(70000,nil,col,50,"DR_LG_HEALER_110",LEATHER,DRUID,HEALER,ANY)			-- Restoration
				AddVariant(70000,nil,col,set,"DR_LG_HEALER_110",TRANSMOG,A(20969,78757,137072),A(26067,78719,137015),A(27243,78780,137095),A(19027,78763,137078),A(25585,78730,137026))
	...
	set = AddSet(70000,nil,RAID,10,"DR_TR_CASTER_10",LEATHER,DRUID,CASTER,ANY)
				AddVariant(70000,nil,RAID,set,"VENDOR",TRANSMOG,50821,50819,50823,50822,50820)
				AddVariant(70000,nil,RAID,set,"NORMAL",TRANSMOG,51149,51147,51145,51148,51146)
				AddVariant(70000,nil,RAID,set,"HEROIC",TRANSMOG,51290,51292,51294,51291,51293)
	...
	set = AddSet(70000,nil,RAID,9,"DR_TR_CASTER_A_09",LEATHER,DRUID,CASTER,ALLIANCE)
				AddVariant(70000,nil,RAID,set,"VENDOR",TRANSMOG,48158,48161,48159,48162,48160)
				AddVariant(70000,nil,RAID,set,"NORMAL",TRANSMOG,48164,48167,48166,48163,48165)
				AddVariant(70000,nil,RAID,set,"HEROIC",TRANSMOG,48171,48168,48169,48172,48170)
	...
	set = AddSet(70000,nil,RAID,9,"DR_TR_CASTER_H_09",LEATHER,DRUID,CASTER,HORDE)
				AddVariant(70000,nil,RAID,set,"VENDOR",TRANSMOG,48174,48177,48176,48173,48175)
				AddVariant(70000,nil,RAID,set,"NORMAL",TRANSMOG,48181,48178,48179,48182,48180)
				AddVariant(70000,nil,RAID,set,"HEROIC",TRANSMOG,48184,48187,48186,48183,48185)
	...
	set = AddSet(70000,nil,RAID,8,"DR_TR_CASTER_08",LEATHER,DRUID,CASTER,ANY)
				AddVariant(70000,nil,RAID,set,"PLAYER10",TRANSMOG,46313,45352,45354,45351,45353)
				AddVariant(70000,nil,RAID,set,"PLAYER25",TRANSMOG,46191,46196,46194,46189,46192)
	...
	set = AddSet(70000,nil,RAID,7,"DR_TR_CASTER_07",LEATHER,DRUID,CASTER,ANY)
				AddVariant(70000,nil,RAID,set,"PLAYER10",TRANSMOG,39545,39548,39547,39544,39546)
				AddVariant(70000,nil,RAID,set,"PLAYER25",TRANSMOG,40467,40470,40469,40466,40468)
	...
	set = AddSet(70000,nil,RAID,6,"DR_TR_CASTER_06",LEATHER,DRUID,CASTER,ANY)
				AddVariant(70000,nil,RAID,set,"DR_TR_CASTER_06",TRANSMOG,31040,31049,31043,34446,31035,34555,31046,34572)
	...
	set = AddSet(70000,nil,RAID,5,"DR_TR_CASTER_05",LEATHER,DRUID,CASTER,ANY)
				AddVariant(70000,nil,RAID,set,"DR_TR_CASTER_05",TRANSMOG,30233,30235,30231,30232,30234)
	...
	set = AddSet(70000,nil,RAID,4,"DR_TR_CASTER_04",LEATHER,DRUID,CASTER,ANY)
				AddVariant(70000,nil,RAID,set,"DR_TR_CASTER_04",TRANSMOG,29093,29095,29091,29092,29094)
	
	set = AddSet(70000,nil,RAID,3,"DR_TR_03",LEATHER,DRUID,ANY,ANY)
				AddVariant(70000,nil,RAID,set,"DR_TR_03",TRANSMOG,22490,22491,22488,22495,22493,22494,22489,22492,23064)
	
	set = AddSet(70000,nil,RAID,2,"DR_TR_02",LEATHER,DRUID,ANY,ANY)
				AddVariant(70000,nil,RAID,set,"DR_TR_02",TRANSMOG,16900,16902,16897,16904,16899,16903,16901,16898)
	
	set = AddSet(70000,nil,RAID,1,"DR_TR_01",LEATHER,DRUID,ANY,ANY)
				AddVariant(70000,nil,RAID,set,"DR_TR_01",TRANSMOG,16834,16836,16833,16830,16831,16828,16835,16829)
	
	-- Challenge Dungeon Sets
	set = AddSet(70000,nil,CHALLENGE,1,"DR_CD_90",LEATHER,DRUID,ANY,ANY)
				AddVariant(70000,nil,CHALLENGE,set,"DR_CD_90",TRANSMOG,90062,90065,90064,90066,90061,90059,90063,90060)

	-- Dungeon Sets
	set = AddSet(70000,nil,DUNGEON,30,"DR_DG_03",LEATHER,DRUID,ANY,ANY)
				AddVariant(70000,nil,DUNGEON,set,"DR_DG_03",TRANSMOG,28348,27737,28202,27468,27873)
				
	set = AddSet(70000,nil,DUNGEON,22,"DR_DG_AQ_2",LEATHER,DRUID,ANY,ANY)
				AddVariant(70000,nil,DUNGEON,set,"DR_DG_AQ_2",TRANSMOG,21353,21354,21357,21356,21355)
				
	set = AddSet(70000,nil,DUNGEON,21,"DR_DG_AQ_1",LEATHER,DRUID,ANY,ANY)
				AddVariant(70000,nil,DUNGEON,set,"DR_DG_AQ_1",TRANSMOG,21407,21409,21408)
				
	set = AddSet(70000,nil,DUNGEON,20,"DR_DG_02",LEATHER,DRUID,ANY,ANY)
				AddVariant(70000,nil,DUNGEON,set,"REPLICA",TRANSMOG,78249,78247,78252,78253,78248,78246,78250,78251)
				AddVariant(70000,nil,DUNGEON,set,"ORIGINAL",TRANSMOG,22109,22112,22113,22108,22110,22106,22111,22107)
				
	set = AddSet(70000,nil,DUNGEON,10,"DR_DG_01",LEATHER,DRUID,ANY,ANY)
				AddVariant(70000,nil,DUNGEON,set,"REPLICA",TRANSMOG,78238,78239,78242,78240,78241,78244,78245,78243)
				AddVariant(70000,nil,DUNGEON,set,"ORIGINAL",TRANSMOG,16720,16718,16706,16714,16717,16716,16719,16715)

	-- PvP
	set = AddSet(70000,nil,PVP,18,"DR_PVP_18",LEATHER,DRUID,ANY,ALLIANCE)
				AddVariant(70000,nil,PVP,set,"ASPIRANT",TRANSMOG,126190,126193,126192,126189,126191)
				AddVariant(70000,nil,PVP,set,"COMBATANT",TRANSMOG,126033,126036,126035,126032,126034)
				AddVariant(70000,nil,PVP,set,"GLADIATOR",TRANSMOG,125831,125834,125833,125830,125832)
				
	set = AddSet(70000,nil,PVP,18,"DR_PVP_18",LEATHER,DRUID,ANY,HORDE)
				AddVariant(70000,nil,PVP,set,"ASPIRANT",TRANSMOG,126667,126670,126669,126666,126668)
				AddVariant(70000,nil,PVP,set,"COMBATANT",TRANSMOG,126510,126513,126512,126509,126511)
				AddVariant(70000,nil,PVP,set,"GLADIATOR",TRANSMOG,126310,126313,126312,126309,126311)
				
	set = AddSet(70000,nil,PVP,17,"DR_PVP_17",LEATHER,DRUID,ANY,ALLIANCE)
				AddVariant(70000,nil,PVP,set,"ASPIRANT",TRANSMOG,125076,125079,125078,125075,125077)
				AddVariant(70000,nil,PVP,set,"COMBATANT",TRANSMOG,124919,124922,124921,124918,124920)
				AddVariant(70000,nil,PVP,set,"GLADIATOR",TRANSMOG,124717,124720,124719,124716,124718)
				
	set = AddSet(70000,nil,PVP,17,"DR_PVP_17",LEATHER,DRUID,ANY,HORDE)
				AddVariant(70000,nil,PVP,set,"ASPIRANT",TRANSMOG,125553,125556,125555,125552,125554)
				AddVariant(70000,nil,PVP,set,"COMBATANT",TRANSMOG,125396,125399,125398,125395,125397)
				AddVariant(70000,nil,PVP,set,"GLADIATOR",TRANSMOG,125196,125199,125198,125195,125197)
				
	set = AddSet(70000,nil,PVP,16,"DR_PVP_16",LEATHER,DRUID,ANY,ALLIANCE)
				AddVariant(70000,nil,PVP,set,"ASPIRANT",TRANSMOG,115203,115206,115205,115202,115204)
				AddVariant(70000,nil,PVP,set,"COMBATANT",TRANSMOG,115055,115058,115057,115054,115056)
				AddVariant(70000,nil,PVP,set,"GLADIATOR",TRANSMOG,115635,115638,115637,115634,115636)
				
	set = AddSet(70000,nil,PVP,16,"DR_PVP_16",LEATHER,DRUID,ANY,HORDE)
				AddVariant(70000,nil,PVP,set,"ASPIRANT",TRANSMOG,119980,119983,119982,119979,119981)
				AddVariant(70000,nil,PVP,set,"COMBATANT",TRANSMOG,119845,119848,119847,119844,119846)
	...
	set = AddSet(70000,nil,PVP,15,"DR_PVP_MELEE_15",LEATHER,DRUID,MELEE,ALLIANCE)
				AddVariant(70000,nil,PVP,set,"ALLIANCE",TRANSMOG,102653,102741,102740,102739,102645)
				AddVariant(70000,nil,PVP,set,"ELITE",TRANSMOG,103010,103013,103012,103009,103138,103011,103137)
	...
	set = AddSet(70000,nil,PVP,15,"DR_PVP_CASTER_15",LEATHER,DRUID,CASTER,ALLIANCE)
				AddVariant(70000,nil,PVP,set,"ALLIANCE",TRANSMOG,102634,102700,102614,102696,102767)
				AddVariant(70000,nil,PVP,set,"ELITE",TRANSMOG,103025,103028,103027,103024,103022,103026,103023)
	...
	set = AddSet(70000,nil,PVP,15,"DR_PVP_CASTER_15",LEATHER,DRUID,CASTER,HORDE)
				AddVariant(70000,nil,PVP,set,"HORDE",TRANSMOG,103398,103399,103400,103401,103402)
				AddVariant(70000,nil,PVP,set,"ELITE",TRANSMOG,103025,102022,103023,103024,103026,103027,103028)
	...
	set = AddSet(70000,nil,PVP,14,"DR_PVP_CASTER_14",LEATHER,DRUID,CASTER,ALLIANCE)
				AddVariant(70000,nil,PVP,set,"ALLIANCE",TRANSMOG,100287,100293,100291,100285,100289)
				AddVariant(70000,nil,PVP,set,"ELITE",TRANSMOG,100288,100294,100292,100286,100290)
	...
	set = AddSet(70000,nil,PVP,14,"DR_PVP_CASTER_14",LEATHER,DRUID,CASTER,HORDE)
				AddVariant(70000,nil,PVP,set,"HORDE",TRANSMOG,100577,100646,100557,100642,100713)
				AddVariant(70000,nil,PVP,set,"ELITE",TRANSMOG,100288,100294,100292,100286,100290)
