		...
		if maxVersion == nil or WOW_VERSION <= maxVersion then
			...
			for j = 1,n do
				...
				if type(v) == 'number' then
					SetCollector:Print(v)
					local itemID = v or 0
					SetCollector:Print(itemID)
					local sLink = select(2,GetItemInfo(itemID))
					SetCollector:Print(sLink)
					a, s, i = SetCollector:GetAppearanceInfo(sLink)
					SetCollector:Print(a)
					SetCollector:Print(s)
					SetCollector:Print(i)
				else
					a = v.a or 0
					s = v.s or 0
					i = v.i or 0
...
local function GetGeneralAppearances()
	...
	set = AddSet(50400,nil,LEGENDARY,4,"LG_85",ANY,ANY,CASTER,ANY)
				AddVariant(50400,nil,LEGENDARY,set,"LG_85",TRANSMOG,71086)
...
local function GetDruidAppearances()
	...
	set = AddSet(50400,nil,RAID,16,"DR_TR_CASTER_16",LEATHER,DRUID,CASTER,ANY)
				AddVariant(50400,nil,RAID,set,"RAIDFINDER",TRANSMOG,98995,98998,98997,98994,98996)
	...
	set = AddSet(50400,nil,RAID,16,"DR_TR_MELEE_16",LEATHER,DRUID,MELEE,ANY)
				AddVariant(50400,nil,RAID,set,"RAIDFINDER",TRANSMOG,99043,99022,99041,99042,99044)
	...
	set = AddSet(50400,nil,RAID,16,"DR_TR_TANK_16",LEATHER,DRUID,TANK,ANY)
				AddVariant(50400,nil,RAID,set,"RAIDFINDER",TRANSMOG,99001,98978,98999,99000,98981)
	...
	set = AddSet(50400,nil,RAID,16,"DR_TR_HEALER_16",LEATHER,DRUID,HEALER,ANY)
				AddVariant(50400,nil,RAID,set,"RAIDFINDER",TRANSMOG,99013,99016,99015,99012,99014)
	...
	set = AddSet(50400,nil,RAID,15,"DR_TR_CASTER_15",LEATHER,DRUID,CASTER,ANY)
				AddVariant(50400,nil,RAID,set,"RAIDFINDER",TRANSMOG,95846,95849,95848,95845,95847)
				AddVariant(50400,nil,RAID,set,"NORMAL",TRANSMOG,95246,95249,95248,95245,95247)
				AddVariant(50400,nil,RAID,set,"HEROIC",TRANSMOG,96590,96593,96592,96589,96591)

	set = AddSet(50400,nil,RAID,15,"DR_TR_MELEE_15",LEATHER,DRUID,MELEE,ANY)
				AddVariant(50400,nil,RAID,set,"RAIDFINDER",TRANSMOG,95837,95839,95835,95836,95838)
				AddVariant(50400,nil,RAID,set,"NORMAL",TRANSMOG,95237,95239,95235,95236,95238)
				AddVariant(50400,nil,RAID,set,"HEROIC",TRANSMOG,96581,96583,96579,96580,96582)

	set = AddSet(50400,nil,RAID,15,"DR_TR_TANK_15",LEATHER,DRUID,TANK,ANY)
				AddVariant(50400,nil,RAID,set,"RAIDFINDER",TRANSMOG,95852,95854,95850,95851,95853)
				AddVariant(50400,nil,RAID,set,"NORMAL",TRANSMOG,95252,95254,95250,95251,95253)
				AddVariant(50400,nil,RAID,set,"HEROIC",TRANSMOG,96596,96598,96594,96595,96597)

	set = AddSet(50400,nil,RAID,15,"DR_TR_HEALER_15",LEATHER,DRUID,HEALER,ANY)
				AddVariant(50400,nil,RAID,set,"RAIDFINDER",TRANSMOG,95841,95844,95843,95840,95842)
				AddVariant(50400,nil,RAID,set,"NORMAL",TRANSMOG,95241,95244,95243,95240,95242)
				AddVariant(50400,nil,RAID,set,"HEROIC",TRANSMOG,96585,96588,96587,96584,96586)

	set = AddSet(50400,nil,RAID,14,"DR_TR_CASTER_14",LEATHER,DRUID,CASTER,ANY)
				AddVariant(50400,nil,RAID,set,"RAIDFINDER",TRANSMOG,86647,86644,86645,86648,86696)
				AddVariant(50400,nil,RAID,set,"NORMAL",TRANSMOG,85307,85304,85305,85308,85356)
				AddVariant(50400,nil,RAID,set,"HEROIC",TRANSMOG,86934,86937,86936,86933,86930)
	
	set = AddSet(50400,nil,RAID,14,"DR_TR_MELEE_14",LEATHER,DRUID,MELEE,ANY)
				AddVariant(50400,nil,RAID,set,"RAIDFINDER",TRANSMOG,86651,86649,86653,86652,86650)
				AddVariant(50400,nil,RAID,set,"NORMAL",TRANSMOG,85311,85309,85313,85312,85310)
				AddVariant(50400,nil,RAID,set,"HEROIC",TRANSMOG,86925,86927,86923,86924,86926)
	
	set = AddSet(50400,nil,RAID,14,"DR_TR_TANK_14",LEATHER,DRUID,TANK,ANY)
				AddVariant(50400,nil,RAID,set,"RAIDFINDER",TRANSMOG,86721,86723,86719,86720,86722)
				AddVariant(50400,nil,RAID,set,"NORMAL",TRANSMOG,85381,85383,85379,85380,85382)
				AddVariant(50400,nil,RAID,set,"HEROIC",TRANSMOG,86940,86942,86938,86939,86941)
	
	set = AddSet(50400,nil,RAID,14,"DR_TR_HEALER_14",LEATHER,DRUID,HEALER,ANY)
				AddVariant(50400,nil,RAID,set,"RAIDFINDER",TRANSMOG,86697,86694,86695,86698,86646)
				AddVariant(50400,nil,RAID,set,"NORMAL",TRANSMOG,85357,85354,85355,85358,85306)
				AddVariant(50400,nil,RAID,set,"HEROIC",TRANSMOG,86929,86932,86931,86928,86935)
	
	set = AddSet(50400,nil,RAID,13,"DR_TR_CASTER_13",LEATHER,DRUID,CASTER,ANY)
				AddVariant(50400,nil,RAID,set,"RAIDFINDER",TRANSMOG,78791,78839,78757,78771,78809)
				AddVariant(50400,nil,RAID,set,"NORMAL",TRANSMOG,77019,77022,77021,77018,77020)
				AddVariant(50400,nil,RAID,set,"HEROIC",TRANSMOG,78696,78744,78662,78676,78714)

	set = AddSet(50400,nil,RAID,13,"DR_TR_MELEE_13",LEATHER,DRUID,MELEE,ANY)
				AddVariant(50400,nil,RAID,set,"RAIDFINDER",TRANSMOG,78789,78838,78760,78779,78808)
				AddVariant(50400,nil,RAID,set,"NORMAL",TRANSMOG,77015,77017,77013,77014,77016)
				AddVariant(50400,nil,RAID,set,"HEROIC",TRANSMOG,78694,78743,78665,78684,78713)

	set = AddSet(50400,nil,RAID,13,"DR_TR_HEALER_13",LEATHER,DRUID,HEALER,ANY)
				AddVariant(50400,nil,RAID,set,"RAIDFINDER",TRANSMOG,78785,78835,78755,78775,78805)
				AddVariant(50400,nil,RAID,set,"NORMAL",TRANSMOG,76750,76753,76752,76749,76751)
				AddVariant(50400,nil,RAID,set,"HEROIC",TRANSMOG,78690,78740,78660,78680,78710)
	
	set = AddSet(50400,nil,RAID,12,"DR_TR_CASTER_12",LEATHER,DRUID,CASTER,ANY)
				AddVariant(50400,nil,RAID,set,"NORMAL",TRANSMOG,71108,71111,71110,71107,71109)
				AddVariant(50400,nil,RAID,set,"HEROIC",TRANSMOG,71497,71500,71499,71496,71498)

	set = AddSet(50400,nil,RAID,12,"DR_TR_MELEE_12",LEATHER,DRUID,MELEE,ANY)
				AddVariant(50400,nil,RAID,set,"NORMAL",TRANSMOG,71098,71101,71100,71097,71099)
				AddVariant(50400,nil,RAID,set,"HEROIC",TRANSMOG,71488,71490,71486,71487,71489)

	set = AddSet(50400,nil,RAID,12,"DR_TR_HEALER_12",LEATHER,DRUID,HEALER,ANY)
				AddVariant(50400,nil,RAID,set,"NORMAL",TRANSMOG,71103,71106,71105,71102,71104)
				AddVariant(50400,nil,RAID,set,"HEROIC",TRANSMOG,71492,71495,71494,71491,71493)
	
	set = AddSet(50400,nil,RAID,11,"DR_TR_CASTER_11",LEATHER,DRUID,CASTER,ANY)
				AddVariant(50400,nil,RAID,set,"NORMAL",TRANSMOG,60282,60284,60281,60285,60283)
				AddVariant(50400,nil,RAID,set,"HEROIC",TRANSMOG,65200,65203,65202,65199,65201)

	set = AddSet(50400,nil,RAID,11,"DR_TR_MELEE_11",LEATHER,DRUID,MELEE,ANY)
				AddVariant(50400,nil,RAID,set,"NORMAL",TRANSMOG,60286,60289,60287,60290,60288)
				AddVariant(50400,nil,RAID,set,"HEROIC",TRANSMOG,65190,65193,65192,65189,65191)

	set = AddSet(50400,nil,RAID,11,"DR_TR_HEALER_11",LEATHER,DRUID,HEALER,ANY)
				AddVariant(50400,nil,RAID,set,"NORMAL",TRANSMOG,60277,60279,60276,60280,60278)
				AddVariant(50400,nil,RAID,set,"HEROIC",TRANSMOG,65195,65198,65197,65194,65196)

	set = AddSet(50400,nil,RAID,10,"DR_TR_CASTER_10",LEATHER,DRUID,CASTER,ANY)
				AddVariant(50400,nil,RAID,set,"VENDOR",TRANSMOG,50821,50819,50823,50822,50820)
				AddVariant(50400,nil,RAID,set,"NORMAL",TRANSMOG,51149,51147,51145,51148,51146)
				AddVariant(50400,nil,RAID,set,"HEROIC",TRANSMOG,51290,51292,51294,51291,51293)

	set = AddSet(50400,nil,RAID,10,"DR_TR_MELEE_10",LEATHER,DRUID,MELEE,ANY)
				AddVariant(50400,nil,RAID,set,"VENDOR",TRANSMOG,50826,50824,50828,50827,50825)
				AddVariant(50400,nil,RAID,set,"NORMAL",TRANSMOG,51143,51140,51141,51144,51142)
				AddVariant(50400,nil,RAID,set,"HEROIC",TRANSMOG,51296,51299,51298,51295,51297)

	set = AddSet(50400,nil,RAID,10,"DR_TR_HEALER_10",LEATHER,DRUID,HEALER,ANY)
				AddVariant(50400,nil,RAID,set,"VENDOR",TRANSMOG,50108,50113,50106,50107,50109)
				AddVariant(50400,nil,RAID,set,"NORMAL",TRANSMOG,51137,51135,51139,51138,51136)
				AddVariant(50400,nil,RAID,set,"HEROIC",TRANSMOG,51302,51304,51300,51301,51303)
	
	set = AddSet(50400,nil,RAID,9,"DR_TR_CASTER_A_09",LEATHER,DRUID,CASTER,ALLIANCE)
				AddVariant(50400,nil,RAID,set,"VENDOR",TRANSMOG,48158,48161,48159,48162,48160)
				AddVariant(50400,nil,RAID,set,"NORMAL",TRANSMOG,48164,48167,48166,48163,48165)
				AddVariant(50400,nil,RAID,set,"HEROIC",TRANSMOG,48171,48168,48169,48172,48170)

	set = AddSet(50400,nil,RAID,9,"DR_TR_MELEE_A_09",LEATHER,DRUID,MELEE,ALLIANCE)
				AddVariant(50400,nil,RAID,set,"VENDOR",TRANSMOG,48214,48217,48216,48213,48215)
				AddVariant(50400,nil,RAID,set,"NORMAL",TRANSMOG,48211,48208,48209,48212,48210)
				AddVariant(50400,nil,RAID,set,"HEROIC",TRANSMOG,48204,48207,48206,48203,48205)

	set = AddSet(50400,nil,RAID,9,"DR_TR_HEALER_A_09",LEATHER,DRUID,HEALER,ALLIANCE)
				AddVariant(50400,nil,RAID,set,"VENDOR",TRANSMOG,48102,48131,48129,48132,48130)
				AddVariant(50400,nil,RAID,set,"NORMAL",TRANSMOG,48134,48137,48136,48133,48135)
				AddVariant(50400,nil,RAID,set,"HEROIC",TRANSMOG,48141,48138,48139,48142,48140)
	
	set = AddSet(50400,nil,RAID,9,"DR_TR_CASTER_H_09",LEATHER,DRUID,CASTER,HORDE)
				AddVariant(50400,nil,RAID,set,"VENDOR",TRANSMOG,48174,48177,48176,48173,48175)
				AddVariant(50400,nil,RAID,set,"NORMAL",TRANSMOG,48181,48178,48179,48182,48180)
				AddVariant(50400,nil,RAID,set,"HEROIC",TRANSMOG,48184,48187,48186,48183,48185)

	set = AddSet(50400,nil,RAID,9,"DR_TR_MELEE_H_09",LEATHER,DRUID,MELEE,HORDE)
				AddVariant(50400,nil,RAID,set,"VENDOR",TRANSMOG,48188,48191,48189,48192,48190)
				AddVariant(50400,nil,RAID,set,"NORMAL",TRANSMOG,48194,48197,48196,48193,48195)
				AddVariant(50400,nil,RAID,set,"HEROIC",TRANSMOG,48201,48198,48199,48202,48200)

	set = AddSet(50400,nil,RAID,9,"DR_TR_HEALER_H_09",LEATHER,DRUID,HEALER,HORDE)
				AddVariant(50400,nil,RAID,set,"VENDOR",TRANSMOG,48154,48157,48156,48153,48155)
				AddVariant(50400,nil,RAID,set,"NORMAL",TRANSMOG,48151,48148,48149,48152,48150)
				AddVariant(50400,nil,RAID,set,"HEROIC",TRANSMOG,48144,48147,48146,48143,48145)

	set = AddSet(50400,nil,RAID,8,"DR_TR_CASTER_08",LEATHER,DRUID,CASTER,ANY)
				AddVariant(50400,nil,RAID,set,"PLAYER10",TRANSMOG,46313,45352,45354,45351,45353)
				AddVariant(50400,nil,RAID,set,"PLAYER25",TRANSMOG,46191,46196,46194,46189,46192)
	
	set = AddSet(50400,nil,RAID,8,"DR_TR_MELEE_08",LEATHER,DRUID,MELEE,ANY)
				AddVariant(50400,nil,RAID,set,"PLAYER10",TRANSMOG,45356,45359,45358,45355,45357)
				AddVariant(50400,nil,RAID,set,"PLAYER25",TRANSMOG,46161,46157,46159,46158,46160)

	set = AddSet(50400,nil,RAID,8,"DR_TR_HEALER_08",LEATHER,DRUID,HEALER,ANY)
				AddVariant(50400,nil,RAID,set,"PLAYER10",TRANSMOG,45346,45349,45348,45345,45347)
				AddVariant(50400,nil,RAID,set,"PLAYER25",TRANSMOG,46184,46187,46186,46183,46185)
	
	set = AddSet(50400,nil,RAID,7,"DR_TR_CASTER_07",LEATHER,DRUID,CASTER,ANY)
				AddVariant(50400,nil,RAID,set,"PLAYER10",TRANSMOG,39545,39548,39547,39544,39546)
				AddVariant(50400,nil,RAID,set,"PLAYER25",TRANSMOG,40467,40470,40469,40466,40468)
	
	set = AddSet(50400,nil,RAID,7,"DR_TR_MELEE_07",LEATHER,DRUID,MELEE,ANY)
				AddVariant(50400,nil,RAID,set,"PLAYER10",TRANSMOG,39553,39556,39554,39557,39555)
				AddVariant(50400,nil,RAID,set,"PLAYER25",TRANSMOG,40473,40494,40471,40472,40493)

	set = AddSet(50400,nil,RAID,7,"DR_TR_HEALER_07",LEATHER,DRUID,HEALER,ANY)
				AddVariant(50400,nil,RAID,set,"PLAYER10",TRANSMOG,39531,39542,39538,39543,39539)
				AddVariant(50400,nil,RAID,set,"PLAYER25",TRANSMOG,40461,40465,40463,40460,40462)
	
	set = AddSet(50400,nil,RAID,6,"DR_TR_MELEE_06",LEATHER,DRUID,MELEE,ANY)
				AddVariant(50400,nil,RAID,set,"DR_TR_MELEE_06",TRANSMOG,31039,31048,31042,34444,31034,34556,31044,34573)
				
	set = AddSet(50400,nil,RAID,6,"DR_TR_HEALER_06",LEATHER,DRUID,HEALER,ANY)
				AddVariant(50400,nil,RAID,set,"DR_TR_HEALER_06",TRANSMOG,31037,31047,31041,34445,31032,34554,31045,34571)
				
	set = AddSet(50400,nil,RAID,6,"DR_TR_CASTER_06",LEATHER,DRUID,CASTER,ANY)
				AddVariant(50400,nil,RAID,set,"DR_TR_CASTER_06",TRANSMOG,31040,31049,31043,34446,31035,34555,31046,34572)
	
	set = AddSet(50400,nil,RAID,5,"DR_TR_MELEE_05",LEATHER,DRUID,MELEE,ANY)
				AddVariant(50400,nil,RAID,set,"DR_TR_MELEE_05",TRANSMOG,30228,30230,30222,30223,30229)
	
	set = AddSet(50400,nil,RAID,5,"DR_TR_HEALER_05",LEATHER,DRUID,HEALER,ANY)
				AddVariant(50400,nil,RAID,set,"DR_TR_HEALER_05",TRANSMOG,30219,30221,30216,30217,30220)
	
	set = AddSet(50400,nil,RAID,5,"DR_TR_CASTER_05",LEATHER,DRUID,CASTER,ANY)
				AddVariant(50400,nil,RAID,set,"DR_TR_CASTER_05",TRANSMOG,30233,30235,30231,30232,30234)
	
	set = AddSet(50400,nil,RAID,4,"DR_TR_MELEE_04",LEATHER,DRUID,MELEE,ANY)
				AddVariant(50400,nil,RAID,set,"DR_TR_MELEE_04",TRANSMOG,29098,29100,29096,29097,29099)
	
	set = AddSet(50400,nil,RAID,4,"DR_TR_HEALER_04",LEATHER,DRUID,HEALER,ANY)
				AddVariant(50400,nil,RAID,set,"DR_TR_HEALER_04",TRANSMOG,29086,29089,29087,29090,29088)
	
	set = AddSet(50400,nil,RAID,4,"DR_TR_CASTER_04",LEATHER,DRUID,CASTER,ANY)
				AddVariant(50400,nil,RAID,set,"DR_TR_CASTER_04",TRANSMOG,29093,29095,29091,29092,29094)
	
	set = AddSet(50400,nil,RAID,3,"DR_TR_03",LEATHER,DRUID,ANY,ANY)
				AddVariant(50400,nil,RAID,set,"DR_TR_03",TRANSMOG,22490,22491,22488,22495,22493,22494,22489,22492,23064)
	
	set = AddSet(50400,nil,RAID,2,"DR_TR_02",LEATHER,DRUID,ANY,ANY)
				AddVariant(50400,nil,RAID,set,"DR_TR_02",TRANSMOG,16900,16902,16897,16904,16899,16903,16901,16898)
	
	set = AddSet(50400,nil,RAID,1,"DR_TR_01",LEATHER,DRUID,ANY,ANY)
				AddVariant(50400,nil,RAID,set,"DR_TR_01",TRANSMOG,16834,16836,16833,16830,16831,16828,16835,16829)
	
	-- Challenge Dungeon Sets
	set = AddSet(50400,nil,CHALLENGE,1,"DR_CD_90",LEATHER,DRUID,ANY,ANY)
				AddVariant(50400,nil,CHALLENGE,set,"DR_CD_90",TRANSMOG,90062,90065,90064,90066,90061,90059,90063,90060)

	-- Dungeon Sets
	set = AddSet(50400,nil,DUNGEON,30,"DR_DG_03",LEATHER,DRUID,ANY,ANY)
				AddVariant(50400,nil,DUNGEON,set,"DR_DG_03",TRANSMOG,28348,27737,28202,27468,27873)
				
	set = AddSet(50400,nil,DUNGEON,22,"DR_DG_AQ_2",LEATHER,DRUID,ANY,ANY)
				AddVariant(50400,nil,DUNGEON,set,"DR_DG_AQ_2",TRANSMOG,21353,21354,21357,21356,21355)
				
	set = AddSet(50400,nil,DUNGEON,21,"DR_DG_AQ_1",LEATHER,DRUID,ANY,ANY)
				AddVariant(50400,nil,DUNGEON,set,"DR_DG_AQ_1",TRANSMOG,21407,21409,21408)
				
	set = AddSet(50400,nil,DUNGEON,20,"DR_DG_02",LEATHER,DRUID,ANY,ANY)
				AddVariant(50400,nil,DUNGEON,set,"REPLICA",TRANSMOG,78249,78247,78252,78253,78248,78246,78250,78251)
				AddVariant(50400,nil,DUNGEON,set,"ORIGINAL",TRANSMOG,22109,22112,22113,22108,22110,22106,22111,22107)
				
	set = AddSet(50400,nil,DUNGEON,10,"DR_DG_01",LEATHER,DRUID,ANY,ANY)
				AddVariant(50400,nil,DUNGEON,set,"REPLICA",TRANSMOG,78238,78239,78242,78240,78241,78244,78245,78243)
				AddVariant(50400,nil,DUNGEON,set,"ORIGINAL",TRANSMOG,16720,16718,16706,16714,16717,16716,16719,16715)
	...
	set = AddSet(50400,nil,PVP,16,"DR_PVP_16",LEATHER,DRUID,ANY,ALLIANCE)
				AddVariant(50400,nil,PVP,set,"ASPIRANT",TRANSMOG,115203,115206,115205,115202,115204)
				AddVariant(50400,nil,PVP,set,"COMBATANT",TRANSMOG,115055,115058,115057,115054,115056)
				AddVariant(50400,nil,PVP,set,"GLADIATOR",TRANSMOG,115635,115638,115637,115634,115636)
				
	set = AddSet(50400,nil,PVP,16,"DR_PVP_16",LEATHER,DRUID,ANY,HORDE)
				AddVariant(50400,nil,PVP,set,"ASPIRANT",TRANSMOG,119980,119983,119982,119979,119981)
				AddVariant(50400,nil,PVP,set,"COMBATANT",TRANSMOG,119845,119848,119847,119844,119846)
				AddVariant(50400,nil,PVP,set,"GLADIATOR",TRANSMOG,111108,111111,111110,111107,111109)
				
	set = AddSet(50400,nil,PVP,15,"DR_PVP_MELEE_15",LEATHER,DRUID,MELEE,ALLIANCE)
				AddVariant(50400,nil,PVP,set,"ALLIANCE",TRANSMOG,102653,102741,102740,102739,102645)
				AddVariant(50400,nil,PVP,set,"ELITE",TRANSMOG,103010,103013,103012,103009,103138,103011,103137)
				
	set = AddSet(50400,nil,PVP,15,"DR_PVP_HEALER_15",LEATHER,DRUID,HEALER,ALLIANCE)
				AddVariant(50400,nil,PVP,set,"ALLIANCE",TRANSMOG,102776,102658,102721,102657,102761)
				AddVariant(50400,nil,PVP,set,"ELITE",TRANSMOG,103017,103020,103019,103016,103014,103018,103015)
				
	set = AddSet(50400,nil,PVP,15,"DR_PVP_CASTER_15",LEATHER,DRUID,CASTER,ALLIANCE)
				AddVariant(50400,nil,PVP,set,"ALLIANCE",TRANSMOG,102634,102700,102614,102696,102767)
				AddVariant(50400,nil,PVP,set,"ELITE",TRANSMOG,103025,103028,103027,103024,103022,103026,103023)
				
	set = AddSet(50400,nil,PVP,15,"DR_PVP_MELEE_15",LEATHER,DRUID,MELEE,HORDE)
				AddVariant(50400,nil,PVP,set,"HORDE",TRANSMOG,103381,103382,103383,103384,103385)
				AddVariant(50400,nil,PVP,set,"ELITE",TRANSMOG,103012,103009,103010,103011,103013,103137,103138)
				
	set = AddSet(50400,nil,PVP,15,"DR_PVP_HEALER_15",LEATHER,DRUID,HEALER,HORDE)
				AddVariant(50400,nil,PVP,set,"HORDE",TRANSMOG,103389,103390,103391,103392,103393)
				AddVariant(50400,nil,PVP,set,"ELITE",TRANSMOG,103017,103014,103015,103016,103018,103019,103020)
				
	set = AddSet(50400,nil,PVP,15,"DR_PVP_CASTER_15",LEATHER,DRUID,CASTER,HORDE)
				AddVariant(50400,nil,PVP,set,"HORDE",TRANSMOG,103398,103399,103400,103401,103402)
				AddVariant(50400,nil,PVP,set,"ELITE",TRANSMOG,103025,102022,103023,103024,103026,103027,103028)
				
	set = AddSet(50400,nil,PVP,14,"DR_PVP_MELEE_14",LEATHER,DRUID,MELEE,ALLIANCE)
				AddVariant(50400,nil,PVP,set,"ALLIANCE",TRANSMOG,100255,100261,100259,100253,100257)
				AddVariant(50400,nil,PVP,set,"ELITE",TRANSMOG,100256,100262,100260,100254,100258)
				
	set = AddSet(50400,nil,PVP,14,"DR_PVP_HEALER_14",LEATHER,DRUID,HEALER,ALLIANCE)
				AddVariant(50400,nil,PVP,set,"ALLIANCE",TRANSMOG,100270,100276,100274,100268,100272)
				AddVariant(50400,nil,PVP,set,"ELITE",TRANSMOG,100271,100277,100275,100269,100273)
				
	set = AddSet(50400,nil,PVP,14,"DR_PVP_CASTER_14",LEATHER,DRUID,CASTER,ALLIANCE)
				AddVariant(50400,nil,PVP,set,"ALLIANCE",TRANSMOG,100287,100293,100291,100285,100289)
				AddVariant(50400,nil,PVP,set,"ELITE",TRANSMOG,100288,100294,100292,100286,100290)
				
	set = AddSet(50400,nil,PVP,14,"DR_PVP_MELEE_14",LEATHER,DRUID,MELEE,HORDE)
				AddVariant(50400,nil,PVP,set,"HORDE",TRANSMOG,100597,100687,100686,100685,100598)
				AddVariant(50400,nil,PVP,set,"ELITE",TRANSMOG,100256,100262,100260,100254,100258)
				
	set = AddSet(50400,nil,PVP,14,"DR_PVP_HEALER_14",LEATHER,DRUID,HEALER,HORDE)
				AddVariant(50400,nil,PVP,set,"HORDE",TRANSMOG,100722,100602,100667,100601,100707)
				AddVariant(50400,nil,PVP,set,"ELITE",TRANSMOG,100271,100277,100275,100269,100273)
				
	set = AddSet(50400,nil,PVP,14,"DR_PVP_CASTER_14",LEATHER,DRUID,CASTER,HORDE)
				AddVariant(50400,nil,PVP,set,"HORDE",TRANSMOG,100577,100646,100557,100642,100713)
				AddVariant(50400,nil,PVP,set,"ELITE",TRANSMOG,100288,100294,100292,100286,100290)
