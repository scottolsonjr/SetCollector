...
local function GetGeneralAppearances()
	...
	set = AddSet(70000,nil,col,100,"OTH_PLATE_100",PLATE,ANY,ANY,ANY)
				AddVariant(70000,nil,col,set,"OTH_PLATE_100",OBTAIN,TRANSMOG,A(31310,79511),A(31312,79513),A(31313,79515),A(31306,79510),A(31307,79514))
	set = AddSet(70000,nil,col,1001,"OTH_LOCKET_100",ANY,ANY,ANY,ANY)
