...
local function GetGeneralAppearances()
	...
	set = AddSet(70000,nil,col,1103271,"HO_FESTIVE_DRESS",ANY,ANY,ANY,ANY)
				AddVariant(70000,nil,col,set,"GREEN",NOTRANSMOG,A(5657))
				AddVariant(70000,nil,col,set,"PINK",NOTRANSMOG,A(5772))
				AddVariant(70000,nil,col,set,"PURPLE",NOTRANSMOG,A(5773))
				AddVariant(70000,nil,col,set,"RED",NOTRANSMOG,A(5656))
				
	set = AddSet(70000,nil,col,1103272,"HO_FESTIVE_SUIT",ANY,ANY,ANY,ANY)
				AddVariant(70000,nil,col,set,"BLACK",NOTRANSMOG,A(5774))
				AddVariant(70000,nil,col,set,"BLUE",NOTRANSMOG,A(5777))
				AddVariant(70000,nil,col,set,"TEAL",NOTRANSMOG,A(5776))
				AddVariant(70000,nil,col,set,"RED",NOTRANSMOG,A(5775))]]--
	...
	set = AddSet(70000,nil,col,1007,"OTH_SHIPYARD_100",ANY,ANY,ANY,ALLIANCE)
				AddVariant(70000,nil,col,set,"OTH_SHIPYARD_100",TRANSMOG,A(26888,73447))
	set = AddSet(70000,nil,col,1007,"OTH_SHIPYARD_100",ANY,ANY,ANY,HORDE)
				AddVariant(70000,nil,col,set,"OTH_SHIPYARD_100",TRANSMOG,A(26889,73446))
...
local function GetPaladinAppearances()
	...
	set = AddSet(70000,nil,col,191,"PA_TR_19",PLATE,PALADIN,ANY,ANY)
				AddVariant(70000,nil,col,set,"RAIDFINDER",TRANSMOG,A(32147),A(32149),A(32105),A(32151),A(32146),A(32148))		-- Need belt and feet for each variant
				AddVariant(70000,nil,col,set,"NORMAL",TRANSMOG,A(29644),A(29647),A(29707),A(29646),A(29643),A(29645))
				AddVariant(70000,nil,col,set,"HEROIC",TRANSMOG,A(29653),A(29655),A(29717),A(29657),A(29652),A(29654))
				AddVariant(70000,nil,col,set,"MYTHIC",TRANSMOG,A(29452),A(29454),A(29676),A(29456),A(29451),A(29453))
