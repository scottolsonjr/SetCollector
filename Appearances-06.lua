...
local function GetDruidAppearances()
	...
	col = SetCollector.PVP
	set = SetCollector:AddSet(70000,nil,col,18,"DR_PVP_18",LEATHER,DRUID,ANY,ALLIANCE)
	...
	set = SetCollector:AddSet(70000,nil,col,18,"DR_PVP_18",LEATHER,DRUID,ANY,HORDE)
	...
	set = SetCollector:AddSet(70000,nil,col,17,"DR_PVP_17",LEATHER,DRUID,ANY,ALLIANCE)
	...
	set = SetCollector:AddSet(70000,nil,col,17,"DR_PVP_17",LEATHER,DRUID,ANY,HORDE)
...
local function GetHunterAppearances()
	...
	set = SetCollector:AddSet(60000,nil,col,171,"HU_TR_17",MAIL,HUNTER,ANY,ANY)
	...
	col = SetCollector.PVP
	set = SetCollector:AddSet(70000,nil,col,18,"HU_PVP_18",MAIL,HUNTER,ANY,ALLIANCE)
	...
	set = SetCollector:AddSet(70000,nil,col,18,"HU_PVP_18",MAIL,HUNTER,ANY,HORDE)
	...
	set = SetCollector:AddSet(70000,nil,col,17,"HU_PVP_17",MAIL,HUNTER,ANY,ALLIANCE)
	...
	set = SetCollector:AddSet(70000,nil,col,17,"HU_PVP_17",MAIL,HUNTER,ANY,HORDE)
...
local function GetMageAppearances()
	...
	col = SetCollector.PVP
	set = SetCollector:AddSet(70000,nil,col,18,"MA_PVP_18",CLOTH,MAGE,ANY,ALLIANCE)
	...
	set = SetCollector:AddSet(70000,nil,col,18,"MA_PVP_18",CLOTH,MAGE,ANY,HORDE)
	...
	set = SetCollector:AddSet(70000,nil,col,17,"MA_PVP_17",CLOTH,MAGE,ANY,ALLIANCE)
	...
	set = SetCollector:AddSet(70000,nil,col,17,"MA_PVP_17",CLOTH,MAGE,ANY,HORDE)
